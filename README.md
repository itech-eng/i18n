...
[![GoDoc](https://godoc.org/github.com/itech-eng/i18n?status.svg)](https://godoc.org/github.com/itech-eng/i18n)
...
import (
  ...
  "github.com/itech-eng/i18n"
  "github.com/itech-eng/i18n/backends/database"
  "github.com/itech-eng/i18n/backends/yaml"
)
...
### Use built-in interface for translation management with [QOR Admin](http://github.com/itech-eng/admin)

I18n has a built-in web interface for translations which is integrated with [QOR Admin](http://github.com/itech-eng/admin).

```go
Admin.AddResource(I18n)
```

Then a page like this will be added to [QOR Admin](http://github.com/itech-eng/admin) interface
...
You could manage translations' data with [QOR Admin](http://github.com/itech-eng/admin) interface (UI) after registering it into [QOR Admin](http://github.com/itech-eng/admin), however we warn you that it is usually quite hard (and error prone!) to *translate a translation* without knowing its context...Fortunately, the *Inline Edit* feature of [QOR Admin](http://github.com/itech-eng/admin) was developed to resolve this problem!
